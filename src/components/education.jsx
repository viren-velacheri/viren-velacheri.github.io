                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <ul className="school-text">
                                <li><b>Relevant Courses Taken:</b> Operating Systems, Computer Architecture, Data Structures, Discrete Math, Introduction to Programming, Matrices/Matrix Calculations, Probability and Statistics, Natural Language Processing, Algorithms and Complexity, Computer Vision, Computer Networks, Neural Networks, Network Security, Data Mining, Big Data</li>
                            </ul>
                          </div>
                          <div className="col-md-6">
                            <ul className="education">
                                <li><i>Aug 2018 - Exp. May 2022</i></li>
                                <li><i>Cumulative GPA: 3.96</i></li>
                            </ul>
                          </div>
                        </div>
                      </div>
